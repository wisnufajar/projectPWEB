                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <a class="card-link float-left" href="<?= BASEURL ?>kenyangin/detail/<?= $kenyangin['id']; ?>">
                                <img class="float-left mr-3" src="<?= BASEURL ?>app/models/barang/<?= $kenyangin['foto1']; ?>" alt="" width="100px;" height="100px">
                                <div class="">
                        ...
                        <div class="col-md-2">
                            <a href="<?= BASEURL ?>kenyangin/hapus/<?= $kenyangin['id']; ?>" class="badge badge-danger float-right ml-1" onclick="return confirm('Yakin ?');">hapus</a>
