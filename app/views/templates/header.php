...
<head>
	...
	<link rel="shortcut icon" href="<?= BASEURL ?>assets/img/logo/logooo.png">

</head>

<body>
	<header class="navbar navbar-expand-md navbar-dark fixed-top bg-white border-bottom shadow-sm">
		<h5 class="p-2 font-weight-normal"><a href="<?= BASEURL ?>" class="nav-link">Kenyangin</a></h5>
		...
		<div class="collapse navbar-collapse" id="navbars">
			<form id="cari" action="<?= BASEURL ?>kategori/cari" class="input-group p-2" method="POST">
				<input type="text" name="cari" class="form-control" autocomplete="off" placeholder="Cari Makanan atau Minuman" aria-label="cari" aria-describedby="cari" required>
			...
			<ul class="nav nav-pills navbar-nav p-2">
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right mt-3" aria-labelledby="kategori">
						<a class="dropdown-item" href="<?= BASEURL ?>kategori/makanan">Makanan</a>
						<a class="dropdown-item" href="<?= BASEURL ?>kategori/cemilan">Cemilan</a>
						<a class="dropdown-item" href="<?= BASEURL ?>kategori/minuman">Minuman</a>
					</div>
				</li>
			</ul>
			<?php Flasher::header() ?>
