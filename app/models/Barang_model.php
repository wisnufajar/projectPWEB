...
class Barang_model
{
    ...
    public function cariKenyangin($data)
    {
        $keyword = $data['cari'];
    ...
    public function tambah($data, $file)
    {
        ...
        (id_user , nama, id_kategori , harga , stok , deskripsi, created_at, foto1 , foto2 , foto3 , foto4 , foto5 , foto6) 
        VALUES 
        (:id_user , :nama , :id_kategori , :harga , :stok  , :deskripsi , :created_at , :foto1 , :foto2 , :foto3 , :foto4 , :foto5 , :foto6 )";
