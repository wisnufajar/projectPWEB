	...
	<div class="container">
		<div class="row">
			<div class="col-12 col-md">
				<center>
					<img class="mb-2" src="<?= BASEURL ?>assets/img/logo/logooo.png" alt="" width="150" height="150">
					<small class="d-block mb-3 text-muted">Tempat jual beli Makanan Online</small>
				</center>
			</div>
			<div class="col-6 col-md">
				...
				<ul class="list-unstyled text-small">
					...
					<li><a class="text-muted" href="#">Cara Menggunakan Kenyangin</a></li>
				</ul>
			</div>
			<div class="col-6 col-md">
				<h5>Social Media</h5>
...
<script src="<?= BASEURL ?>assets/js/jquery-3.3.1.slim.min.js"></script>
